  ...
  return ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        textStyle: GoogleFonts.notoSansArabic(fontSize: 16, fontWeight: FontWeight.w600),
      ),
    ),
    ...
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(
        ...
        textStyle: GoogleFonts.notoSansArabic(fontSize: 14, fontWeight: FontWeight.w600),
      ),
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      labelStyle: GoogleFonts.notoSansArabic(color: colorScheme.onSurfaceVariant),
      hintStyle: GoogleFonts.notoSansArabic(color: colorScheme.onSurfaceVariant.withValues(alpha: 0.6)),
    ),
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      elevation: 8,
      selectedLabelStyle: GoogleFonts.notoSansArabic(fontSize: 12, fontWeight: FontWeight.w600),
      unselectedLabelStyle: GoogleFonts.notoSansArabic(fontSize: 12, fontWeight: FontWeight.w400),
    ),
