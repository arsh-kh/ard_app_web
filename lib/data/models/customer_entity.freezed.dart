...
class _$CustomerEntityImpl implements _CustomerEntity {
  ...
  @override
  String toString() {
    return 'CustomerEntity(id: $id, userId: $userId, businessName: $businessName, phone: $phone, address: $address, debtBalance: $debtBalance, imageUrl: $imageUrl, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
