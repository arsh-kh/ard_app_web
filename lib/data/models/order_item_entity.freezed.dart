...
class _$OrderItemEntityImpl implements _OrderItemEntity {
  ...
  @override
  String toString() {
    return 'OrderItemEntity(id: $id, businessId: $businessId, orderId: $orderId, productId: $productId, quantity: $quantity, returnedQuantity: $returnedQuantity, unitPrice: $unitPrice, buyPrice: $buyPrice, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
