...
class PurchaseReturnRepository {
  ...
  Future<DebtCalculation> previewSupplierDebtReduction(
    ...
    // If the supplier has negative debt (they owe us) or 0 debt, we deduct nothing.
  ...
  Future<void> createPurchaseReturn(
    ...
    // 3. Atomically decrement the supplier debt balance
    if (debtCalc.actualDeduction > 0) {
      final supplierRef = _firestore
          .collection('suppliers')
          .doc(returnRecord.supplierId);
    ...
    await _auditService.logAction(
      ...
      details:
          ...
          'Supplier Debt: ${debtCalc.debtBefore.toStringAsFixed(0)} → ${debtCalc.debtAfter.toStringAsFixed(0)} '
